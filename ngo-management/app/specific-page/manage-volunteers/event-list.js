...
export default function EventList({eventList, passEditVolunteer, passEventUp2}) {
    ...
    return (
        <main>
            <div className="flex flex-col items-center md:flex-row md:flex-wrap md:justify-center w-full">
                ...
                {eventList.map((event,index) => (
                    <div key={index}>
                        ...
                        <div className=" w-96" >
                            <EventCard  event={event} passEventUp1={handlePassEvent} editVolunteers={handlePassEdit}/>
                        </div>
                    )}
                    </div>
                ))}
            ...
            <div className="flex-col items-center md:flex-row md:flex-wrap md:justify-center w-full hidden">
